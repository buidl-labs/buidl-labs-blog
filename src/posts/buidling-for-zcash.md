...
This example illustrates why financial privacy is important:
...
Only question left answering was: what can we build?

## How did we find the niche space in which we can contribute to the community?

First we did a breadth first search of the areas that community wanted help in, and in this search we came across this [list of grant ideas.](https://www.zfnd.org/grants/#ideas) We then researched each idea in depth to get vantage on why exactly is this idea needs a solution from a community perspective. After spending a week on the Internet understanding and chewing on the concepts and then figuring out the difficulty of each idea we had bunch of questions that needed answers before moving ahead.

Here we got in touch with Sonya Mann, who runs communications at ZCash foundation with our doubts. She patiently listended to our questions and pointed us in the right directions. We also realized that this research would be valuable for the community at large and hence assimilated all our research into one document and created an [FAQ around grant ideas on ZCash's community forum.](https://forum.zcashcommunity.com/t/faq-around-grant-ideas/33648)

Another thing which we felt while interacting with the community is how impressive the community's stance is on public discourse and discussion. Take a look yourself to see the wide ranging and nuanced discussions that happen around the issues in the commmunity and participate!

### Zeroing in

Afer assessing our strengths and the limited vantage we had acquired so far about ZCash, we decided to brainstorm a solution to for the Ongoing Services section where the community wanted a "service status dashboard" that monitors the status of the dozens of ZCash related online services.

## How did we go about getting funds for the value we wanted to create for the community?

#### Step 1: Get vantage about the problem

In our research for a solution, we noticed there didn't exist a single source of truth for these services leading to information asymmetry for the ZCash users. One example of the problem: different block explorers reporting different state of the ZCash blockchain.

Next we went about doing an exhaustive research to figure out what all different services that existed in the ZCash ecosystem and how to go about creating a standardized source of truth. The outcome of the above research process yielded [ZCash Ongoing Services Exhaustive List](https://docs.google.com/spreadsheets/d/1ESq4EA4dQ9UB3sUNiBwLEXm26YhUMheXbzr-ednFI0M/edit#gid=0) - which covered all the different services that we were able to find and then organized them into buckets.

#### Step 2: Get alignment consensus with the community around proposed solution

We shared this sheet in ZCash Community Chat where community members helped us in refining the above list. After getting a 👍 to proceed ahead, we sketched out the solution in solving the problem which in theory looked out this:
...
1. The first proposal would cover the expenses related in laying the foundation of the dashboard + 1/3rd of the services that we had discovered.
2. The second proposal would build up on the foundation by extending the surface area of monitoring by adding 2/3rd of the remaining services.

The reason behind splitting the value proposition was twofolds:

1. Ship out an MVP: since we were operating in a new paradigm in a technology we don't fully understand, we wanted to ship out functional MVP with reduced scope. The lessons learnt while shipping as well as the feedback we would gain from the community, will give us insights on how to tune our operations.
...
1. After various iterations on the draft to ensure clarity and objectivity around outcomes, we submmitted our [first proposal on ZF Grants Platform.](https://grants.zfnd.org/proposals/761374418-zcash-service-status-dashboard)
...
3. We also posted the [link to the proposal on ZCash Community forum](https://forum.zcashcommunity.com/t/zcash-service-status-dashboard/33982) to 🚨 the community at large of what are trying to build as well as inviting them for feedback.

#### Step 4: Get funded!

The ZCash Foundation was kind enough to take a bet on us by funding our first proposal! We use the same process and followed up with a second proposal which was funded by the foundation again. 🙏

## What processes we followed while building to ensure accountability, clarity and alignment towards the outcome?

In all this process, we kept our heads level headed to keep the perspective that the foundation is betting on random people on the Internet who they haven't met and aren't accessible at all time. We wanted to ensure that we live up to the trust. We created a system of weekly heartbeat accountability - where we documented weekly progress made on a google doc that was shared with the community. Following are their links:
...
Our team is aiming to building more infrastructure projects that help the ZCash community in this year 🚀

## Closing Notes

We believe that financial privacy is a fundamental right for every individual. We concur with [Vitalik Buterin's views on ZCash Project](https://twitter.com/VitalikButerin/status/1204803955131322369?s=20) that Electric Coin Company and ZCash Foundation are doing a stellar job in diligently building out the this important technology. We recommend reading [Electric Coin Company's roadmap for 2020](https://electriccoin.co/blog/ecc-flight-plan-for-2020/) to see the impressive work in store this year.

We are personally bullish on consumer-facing shielded lite wallets in reducing friction in the adoption of shielded transactions.
